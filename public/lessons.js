...
function createLessonCard(lesson, index) {
  ...
  div.className = 'flex items-center gap-4 bg-white dark:bg-gray-800 p-4 rounded-xl shadow-sm justify-between';
  div.innerHTML = `
    <div class="flex items-center gap-4 w-full">
      ...
      <div class="flex flex-col justify-center flex-1 min-w-0">
        ...
        <p class="text-sm font-normal leading-normal text-text-muted-light dark:text-text-muted-dark">${lesson.description || ''}</p>
      </div>
    </div>
